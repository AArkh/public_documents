# 10DAN – Privacy Policy(Draft)

This Privacy Policy explains how Zing Coach Inc. (further will be referred as “we” or “us”) collects, stores, uses and protects your personal data in connection with your use of our website https://zing.coach/ (or its related pages such as, but not limited to, https://zing-gym.coach/) (the “Website”) and our application Zing Coach (the “App”, and together with the Website referred to as the “Services”). This policy also explains the rights you have in respect of your personal data and the practices we implement to protect your privacy.

1. Personal Data We Collect
Personal data that you provide:
General details. This includes your name, email, your age, account credentials, subscription details, transaction history. You may also choose to provide information about your gender.
Communication information. If you communicate with us, via support channels, we collect and process your name, contact information, and contents of any messages you send.
Account photo. This is the photo you voluntarily decide to upload as your profile picture.
...
Health and well-being data. When you use the Services, you may choose to input personal data about you, such as your weight; height; body mass index (BMI, a value derived from the mass and height of a person); your physical parameters; information about your workout habits; any injuries you may have. With your consent, you may also allow us to connect to third-party services, such as Apple HealthKit or Google Health Connect, to enable us to import information about your health and activities into the App. Such imported data may include information about your fitness activities, weight, height, BMI, calories burnt, heart rate, number of steps/distance traveled, data about your menstrual cycles (if applicable). We will process these data to provide you with App functionality and features. Importing such data is subject to the Google Health Connect and Apple HealthKit privacy policies and terms.
AI Assistant conversations. When you use our AI Assistant in the App or through the messengers where we make the AI Assistant available, we store the conversations.
Body Scan photos. To be provided with Body Scan reports, you may share with us the photos of your body. We may use the photos for the purpose of Services improvement, so that the Body Scan feature provides better results in the future. Where required under applicable laws, we rely on your explicitly given consent. In any case, we do our best to preserve your privacy - we don’t want to use more of your personal information than is necessary to develop our features and models. Please note that you can opt out from your photos being used for Services improvement at any time by contacting us at support@zing.coach, and we will stop using your future Body Scan photos for that purpose.
Personal data that we receive automatically from your use of the Services:
Log data. It means the information that your browser automatically sends whenever you use our Website, or whenever you access the App. It includes the IP address, browser type, date and time of your access.
...
Cookies and similar technologies. We use cookies and similar technologies to operate and administer the Services and improve your experience there. For details, please read Section “Cookies, Software Development Kits, and Other Tracking Technologies” below.
Personal data that we receive from other sources:
We receive information from our trusted partners, such as security partners to protect against fraud, abuse, and other security threats to our Services or marketing vendors who provide us with information about potential customers of our business services.
...
To provide you with and maintain our Services: It includes the creation of a personalized workout plan for you or making adjustments to it; communication with AI Assistant, which is powered by GPT API (developed by OpenAI); making Body Scans.
...
Upon your consent, where required, to send you marketing information about our Services, promotions, insights. You can opt-out from receiving marketing emails by following the “Unsubscribe” link in the email or by contacting us at support@zing.coach.
To integrate data between the Website and the App in connection with onboarding users.
Upon your consent, where required, to find audiences similar to our users. For this processing, we may share, among others, details of your use of the App (e.g., the fact that you work out with the App), your device information, and details of your subscription purchase with our third-party advertising partners like AppsFlyer. 
...
3.1. Purpose of processing: To provide and maintain our Services‍
...
Where necessary to perform a contract with you, such providing you with a personalized workout plan, or enabling communications with AI Assistant, or performing Body Scans for you. For processing of your health and wellbeing data, we rely on your consent.

3.2. Purpose of processing: To improve and develop our Services and features and conduct research

Type of personal data processed:

General details
Communication information
Conversations with AI Assistant (de-identified)
Body Scan photos
Log data
Usage details
Device information
Movements during workout
AI Body Scan information
Cookies and similar technologies
Data we receive from other sources
Legal basis: Where necessary for our legitimate interests, including in developing and improving, such as when we train our models or improve the App for your future experience. For use of your Body Scan photos, we reply on your consent.

3.3. Purpose of processing: To check if your age allows you to use the App

Type of personal data processed: General details

Legal basis: Where necessary to perform a contract with you, such providing you with our services only if you meet the age threshold.

3.4. Purpose of processing: To provide you with customer support and respond to your inquiries
...
Usage details
Device information
Legal basis: Where necessary for our legitimate interests, in particular in supporting your customer journey.

3.5. Purpose of processing: To send you service emails, including security alerts or transaction confirmations
...
Usage details
Device information
Legal basis: Where necessary to comply with an obligation arising out of a contract between us or out of applicable laws.

3.6. Purpose of processing: To send you marketing information about our Services, promotions, insights
...
Usage details
Device information
Legal basis: Your consent where we ask for it to process your personal data for a specified purpose.

3.7. Purpose of processing: To integrate data between the Website and the App in connection with onboarding users
...
Usage details
Device information
Legal basis: It’s our legitimate interest to ensure your smooth use of the Services.

3.8. Purpose of processing: To find audiences similar to our users
...
Usage details
Device information
Legal basis: With your consent, we may share some of your non-health personal data with AppsFlyer or similar services to promote our Services.

3.9. Purpose of processing: To prevent misuse of our Services and to ensure the security of our IT systems, architecture, and networks
...
3.11. Purpose of processing: To anonymize your personal data
...
Data we receive from other sources
Usage details
Legal basis: Where necessary for our legitimate interests, such as when we use it to:
...
4.1. Category of personal data: Identifiers, such as name, unique personal identifier, online identifier, IP address, email address, or account name

Categories of sources from which collected: Directly from you or automatically when you use the Services

Business or Commercial Purpose for Collecting Personal Information:

To present you with the App and its contents and any other information, products or services that you request from us.
To carry out our obligations and enforce our rights arising from any contracts entered into between you and us in relation to the Services.
To customize our product and service offerings to you, for example, offering pricing personalization and discounts. 
To communicate with you, such as to notify you about changes to the Services or any products or services we offer or provide through the App, provide you with customer or technical support, and monitor and improve our responses to your and other users’ inquiries 
To conduct research, analytics and monitor performance and other metrics regarding the Services and your use of the Services.
To improve, test, and monitor the effectiveness of the Services.
To provide personalized content and information to you in relation to the App, and so that we, and third parties on which we rely, can advertise to you. 
To send marketing and promotional communications to you.
...
To our affiliates, contractors, vendors and service providers to process in accordance with our instructions.
to parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.2. Category of personal data: Characteristics of Protected Classifications, such as gender

Categories of sources from which collected: Directly from you

Business or Commercial Purpose for Collecting Personal Information:

To present to you with the App and its contents and any other information, products or services that you request from us.  
To carry out our obligations and enforce our rights arising from any contracts entered into between you and us in relation to the Services.
In any other way as we may describe when you provide the information or otherwise at your direction or with your consent.
As permitted or required by law, including for auditing, fraud and security monitoring purposes.
Categories of Third Parties and Other Entities To Whom We May Disclose:
...
To parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.3. Category of personal data: Commercial information, such as records of products or services purchased, obtained or considered, or other purchasing or consuming histories of tendencies

Categories of sources from which collected: Automatically when you use the Services
...
to parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.4. Category of personal data: Internet or other electronic network activity information, such as information regarding interaction with an app or advertisement
...
to parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.5. Category of personal data: Geolocation data, such as the state or country associated with your IP address
...
To improve, test, and monitor the effectiveness of the Services.
To provide personalized content and information to you in relation to the App, and so that we, and third parties on which we rely, can advertise to you.
To send marketing and promotional communications to you.In any other way as we may describe when you provide the information or otherwise at your direction or with your consent.
As permitted or required by law, including for auditing, fraud and security monitoring purposes.
Categories of Third Parties and Other Entities To Whom We May Disclose:
...
to parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.6. Category of personal data: Visual, information, such the photos you upload to the App
...
To present you with the App and its contents and any other information, products or services that you request from us.
To generate body composition reports.
To improve, test, and monitor the effectiveness of the Services.
Categories of Third Parties and Other Entities To Whom We May Disclose:
...
To parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.7. Category of personal data: Inferences drawn from the information listed above to create a profile about a user reflecting their preferences, characteristics and other attributes
...
to parties involved in strategic transactions, reorganization, bankruptcy, receivership, or transition of a service to another provider.
In response to legal requests and for purposes of preventing harm.
4.8. Category of personal data: Information that may be sensitive personal data, such as gender, health and wellbeing information

Categories of sources from which collected: Directly from you or from such other sources that you connect to the Services
...
Sharing personal data for cross-context behavioral advertising. We may share the following categories personal information with third-party ad-tech providers and others throughout the online advertising ecosystem for purposes of cross-context behavioral advertising:
...
Depending on location, individuals may have certain statutory right in relation to their personal data. For example, you may have the right to: 
...
You can exercise some of the rights above through the App settings. If you are unable to exercise your rights through the App, please submit your request through support@zing.coach.
...
If you want to report a security incident related to our Services, please contact us at support@zing.coach.

8. Children
Our Services are not directed at, or intended for, children under 18 years old.

If you are aware of anyone under 18 using the Services, please contact us at support@zing.coach and we will take the required steps to delete such information and/or delete the account.
...
Meta Events Manager (USA)

6. User onboarding and data integration 
...
When you use our Services, we and our service providers, vendors, and partners, including third parties, may use cookies (a small text file placed on your computer or mobile device to identify your computer and web browser) and other similar technologies to collect or receive certain information about you and/or your use of our Services. However, it’s not only cookies that can be used in this way. Functions performed by a cookie can be achieved by other means, too. This Section, therefore, also applies to any similar technology that stores or accesses information on your device. This could include, for example, HTML5 local storage, local shared objects, beacons, pixels, and plug-ins. We also use third-party analytics tools (such as, but not limited to, AppsFlyer, Meta Events Manager, Firebase) to help us measure traffic and usage trends of our Services, as well as for other analytics purposes. Such analytics tools collect information via third-party SDKs incorporated into the Services, which includes information about features of the App you visit or use, your actions in the App, and information about your subscription. Such information may be used to provide content, advertising, or functionality. Third parties may also use such information for their own purposes. For the avoidance of doubt, we do not use health and wellbeing data for advertising purposes.
...
Classified by their provenance, there are first-party and third-party cookies. First-party cookies refer to cookies that Zig Coach sets and uses directly. Third-party cookies refer to cookies set by third parties (such as our analytics providers) through our Website or via server cookies.
Classified by their purpose, we use Strictly Necessary, Performance and Marketing cookies.
Strictly Necessary cookies. These cookies are strictly necessary to provide you with the Website and the features you have requested, such as to allow you to log into secure areas of the Website. Because these cookies are essential for the Website and the features you have requested to work, you cannot reject them. We use such cookies for the following essential purposes:
...
Marketing cookies. These cookies help us reach you and more people like you to spread the word about the App, as well as analyze whether we do that effectively. Zing Coach does not use cookies to collect or analyze your health information for marketing purposes. We use marketing cookies to analyze and improve our marketing campaigns. This helps us to:
...
Software Development Kits (SDKs). SDKs are third-party software development kits that may be installed in our mobile application. SDKs help us understand how you interact with our App and collect certain information about the device and network you use to access the application. Our App is never used to present you with third-party advertising. You can browse with full confidence in the protection of your privacy. Access is requested with the purpose of enabling the use of our services and improving their functioning. Certain SDKs, where legally required, are subject to a prior consent request and the possibility of withdrawing this consent. Zing Coach services may still be used even in the event of refusal or withdrawal of consent.
...
For users in the European Economic Area, United Kingdom, and United States. You can manage the collection and processing of Personal Data via cookies, SDKs, and other tracking technologies by contacting us at support@zing.coach. 
...
If required by law, we will ask for your consent to send you promotional and marketing emails, in-app communications, and push notifications about new products, features, or offers related to our Services. Promotional and marketing communications may include information about our Services as well as offers from our trusted partners that we believe may be relevant to you. However, we do not share your personal data with third parties for their own direct marketing purposes.
...
Push Notifications. If you wish to stop receiving push notifications, you can do so through your mobile device settings by tapping “Settings” -> “Notifications” -> Choose Zing Coach -> press the toggle to allow or forbid push notifications from the App.
...
Link to the privacy policy, October 8, 2024

Link to the privacy policy, May 30, 2024

Link to the privacy policy, March 15, 2024

Link to the privacy policy, March 1, 2024

Link to the privacy policy, Nov 6, 2023

Link to the privacy policy, June 12, 2023

Link to the privacy policy, May 9, 2022

Link to the privacy policy, March 1, 2021‍

13. Contact Us
Zing Coach, Inc.

Email: support@zing.coach

Our DPO: privacy@palta.com (please, indicate in the email subject that you are a Zing user).

EU representative:‍

‍privacy@palta.com (please indicate in the email subject that you are a Zing user).
